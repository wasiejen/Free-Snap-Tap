...
## Launch
- Launch the planner (`planner_Q3S_160K`, or the planner id named in a maintainer
...
- **End of loop (autorun_summary skill):** on `stop` (goal reached / unrecoverable /
  ...
  agent (e.g. `agent_Q3S_160K` — per the roster in opencode.jsonc; do NOT switch the
