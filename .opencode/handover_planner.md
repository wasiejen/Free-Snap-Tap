...
> **Boot note (2026-09-08):** the current workflow is the planner/worker split — see
> `AGENTS.md` and `.opencode/prompt_agent_planner.md`. The rules below are historical
> (Phase 5) and are superseded where they conflict.
